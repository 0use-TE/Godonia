...
namespace GodotPlugins
{
    public class PluginLoadContext : AssemblyLoadContext
    {
        ...
        private readonly AssemblyLoadContext[] _extraSharedContexts;
            ...
            : base(isCollectible)
        {
            ...
            _extraSharedContexts = extraSharedContexts is { Count: > 0 }
                ? [.. extraSharedContexts]
                : [];
        ...
        protected override Assembly? Load(AssemblyName assemblyName)
        {
            ...
            {
                foreach (var context in _extraSharedContexts)
                {
                    var loaded = FindLoaded(context, assemblyName.Name);
                    if (loaded != null)
                        return loaded;
                }

                var fromMain = FindLoaded(_mainLoadContext, assemblyName.Name);
                if (fromMain != null)
                    return fromMain;
